 ...
 * @returns {Array} Upgrades list
 */
export function getUpgrades() {
  return inventoryData.upgrades || [];
}

/**
 * Get upgrades disclaimer
 * @returns {string} Disclaimer text
 */
export function getUpgradesDisclaimer() {
  return inventoryData.upgradesDisclaimer || "";
}

/**
 * Get warranty info
 * @returns {Object} Warranty details
 */
export function getWarranty() {
  return inventoryData.warranty || {};
}

/**
 * Get build time info
 * @returns {Object} Build time details
 */
export function getBuildTime() {
  return inventoryData.buildTime || {};
}
